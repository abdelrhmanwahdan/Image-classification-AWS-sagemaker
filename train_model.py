...
def train(args, model, train_loader, test_loader, optimizer, loss_criterion, hook):
    '''
...
def main(args):
    ...
    '''
    model=train(args, model, train_loader, test_loader, optimizer, loss_criterion, hook)
